...
# Constant
params = c(0.01,0.05,0.25,0.5) # constant case
params = c(0.1,0.25,0.5,0.75) # zipfs case
params = c(0.001,0.005,0.015,0.05) # geom case
SimNo <- seq_along(params)

# Parallel execution 
param <- params[SimNo[1]]; rstudioapi::jobRunScript(path = scriptpath, importEnv = TRUE)
