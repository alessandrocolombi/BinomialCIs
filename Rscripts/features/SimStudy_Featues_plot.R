...
lub_PP3_mat <- lub_MixPois_mat <- ub_Freq_mat <- lub_MixBin_mat <- oracle_mat <- c()
for(ii in sim_idx){
  file_name = paste0("../save/SimStudyFeatures_geom_",ii,".Rdat")  
  load(file_name)
  lub_PP3_mat = cbind(lub_PP3_mat, save_res$lub_PP3_mat)
  lub_MixPois_mat = cbind(lub_MixPois_mat, save_res$lub_MixPois_mat)
  ub_Freq_mat = cbind(ub_Freq_mat,save_res$ub_Freq_mat)
...
load("../save/SimStudyFeatures_geom_all.dat")
lub_PP3_mat = save_res$lub_PP3_mat
lub_MixPois_mat = save_res$lub_MixPois_mat
ub_Freq_mat = save_res$ub_Freq_mat
lub_MixBin_mat = save_res$lub_MixBin_mat
...
save_img = TRUE
img_name = paste0("../img/SSFeatures_geom.pdf")
...
# save(coverages, file = "../save/SimStudyFeatures_coverages_geom_all.dat")
